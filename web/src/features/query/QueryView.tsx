  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center p-8 rounded-lg border border-dashed border-gray-300 dark:border-gray-600">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('security.query.sqlEditor')}</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">{t('security.query.subtitle')}</p>
